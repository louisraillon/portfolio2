export default function Contact() {
  return (
    <section id="contact" style={{ background: '#1B4332' }}>
      <div className="mx-auto max-w-6xl px-6 py-24 md:px-12 md:py-36">
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          <a
            ...
            className="rounded-full px-7 py-3.5 font-body text-sm font-semibold transition-opacity hover:opacity-90 active:-translate-y-px"
        ...
        >
          ...
          <p className="font-mono text-[10px] text-emerald-300/50">Paris, France</p>
        </div>
      </div>
    </section>
  )
